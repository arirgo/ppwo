			...
			<ul class="breadcrumb">
				...
				<div class="panel panel-default">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Take PP</h4>
                    </div>
								   ...
								   // mengulangi data agar tidak hanya 1 yang tampil
									...
									while($data = mysqli_fetch_array($query_input)){
										...
										if($data['status_pp']=='waiting'){
												echo '<td>
														  <a href="#" class="edit-record" data-id="'.$data['no_pp'].'" ><button type="submit" class="btn btn-warning btn-xs">TAKE</button></a></td>';
