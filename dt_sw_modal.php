...
$sqll	=	mysqli_query($koneksi,"select DISTINCT subcategory from dt_pp where category='Software' and pls='$pls' and tgl_tambah like '".$cat."%'");
?>
<div id="piechart-placeholder2"></div>
	...
	<div class="clearfix">
		...
		?>
		<div class="grid3">
		<span class="blue"><b><?php echo $datal['subcategory'];?></b></span>
