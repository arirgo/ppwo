	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			<div class="page-header">
				...
				Overview Work Order IT <?php echo	$status; ?>
				</small>
				</h1>
			</div><!-- /.page-header -->
...
<thead>
	...
	?>					
		<tr>
			...
			<th  data-sortable="true">Tanggal Reject</th>
			<th  data-sortable="true">Alasan</th>
		</tr>
	</thead>
...
//$sql	=	mysqli_query($koneksi,"select * from tbl_wo where status_wo like 'reject%' and tgl_permohonan like '".$tgl."%'");
$sql	=	mysqli_query($koneksi,"select * from tbl_wo where status_wo like 'reject%' and pls='$pls'");
...
require_once('config.php');
//$sql	=	mysqli_query($koneksi,"select * from tbl_wo where status_wo = '".$status."' and tgl_permohonan like '".$tgl."%'");
$sql	=	mysqli_query($koneksi,"select * from tbl_wo where status_wo = '".$status."' and pls='$pls'");
