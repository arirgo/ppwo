...
$sqla = mysqli_query($koneksi,"select tbl_pp.*,master_komputer.*,inventarisi.nama_barang,kode,group_brg,jenis_group,objectid from tbl_pp left join master_komputer on tbl_pp.komputer=master_komputer.nama_komputer left join inventarisi on tbl_pp.nama_project=inventarisi.nama_barang where tbl_pp.no_pp='".$nopp."'");
...
<?php if($dev=='pro'){
	$no=0;
	$ckmod	=	mysqli_query($koneksi,"select * from modul_pp where no_pp='".$data['no_pp']."'");
	 $cekdt=mysqli_num_rows($ckmod);
	if($cekdt >0){
		while($md= mysqli_fetch_array($ckmod)){
		$no++;
		?>
				<input type="hidden" name="cb_brg[<?php echo $no;?>]" id="cb_brg<?php echo $no;?>" value="<?php echo $data['jenis_group']." / ".$data['nama_project']." / ".$data['objectid'];?>">
			
				<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Modul<?php echo $no;?></label>
					<div class="col-sm-9">
						<input type="text" name="txtdes[<?php echo $no;?>]" id="txtdes<?php echo $no;?>" value="<?php echo $md['nama_modulpp'];?>">
						<label style='margin-left: 5px;' id=pesan2></label>
					</div>
			</div>
		<?php  } ?>
				<input type="hidden" name="angka" id="angka" value="<?php echo $no; ?>">	
		<?php	}else{ ?>
			
			<input type="hidden" name="cb_brg[1]" id="cb_brg1" value="<?php echo $data['jenis_group']." / ".$data['nama_project']." / ".$data['objectid'];?>">
			<input type="hidden" name="txtdes[1]" id="txtdes1" value="Perbaikan">
...
{ ?>
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Ringkasan pekerjaan</label>
				<div class="col-sm-9">
		...
		<!-- <div class="form-group" id="hide1">
			...
			<div class="col-sm-2">
				<select name="cb_brg[1]" id="cb_brg1" class="chosen-select pilihsf" style="width:10%;">
			...
			<div class="col-sm-2 " >
			<select name="cb_brg[1]" id="cb_brg1" class="chosen-select pilihsf" >
				
  					<option value="" selected>--PILIH--  </option>
					<?php
					$result=mysqli_query($koneksi,"SELECT * FROM inventarisi where objectid !=''  $pr ORDER BY nama_barang asc");
					while($isi  = mysqli_fetch_array($result)){ ?>
					<option value="<?php echo $isi['jenis_group']." / ".$isi['nama_barang']." / ".$isi['objectid']." / ".$isi['kode_it']." / ".$isi['lokasi']." / ".$isi['user'];?>"><?php echo $isi['kode_it']." - ".$isi['nama_barang'];?></option>
					
					<?php } ?>
					</select>
			</div>
		
			<div class="col-sm-3"><input type="text" name="txtdes[1]" size="30">	<a href="#" onclick="remove(1)">Delete</a></div>
			</div>

			<div class="form-group " id="hide2">
			<div class="col-sm-3 " ></div>
			<div class="col-sm-2 " >
			<select name="cb_brg[2]" id="cb_brg2" class="chosen-select pilihsf" >
			...
			<div class="col-sm-3"><input type="text" name="txtdes[2]" size="30">	<a href="#" onclick="remove(2)">Delete</a></div>
			</div>

			<div class="form-group " id="hide3">
			<div class="col-sm-3 " ></div>
			<div class="col-sm-2 " >
			<select name="cb_brg[3]" id="cb_brg3" class="chosen-select pilihsf" >
			...
			<div class="col-sm-3"><input type="text" name="txtdes[3]" size="30">	<a href="#" onclick="remove(3)">Delete</a></div>
			</div>

			<div class="form-group " id="hide4">
			<div class="col-sm-3 " ></div>
			<div class="col-sm-2 " >
			<select name="cb_brg[4]" id="cb_brg4" class="chosen-select pilihsf" >
			...
			<div class="col-sm-3"><input type="text" name="txtdes[4]" size="30">	<a href="#" onclick="remove(4)">Delete</a></div>
			</div>
			...
			<div class="col-sm-3 " ></div>
			<div class="col-sm-2 " >
			<select name="cb_brg[5]" id="cb_brg5" class="chosen-select pilihsf" >
			...
			<div class="col-sm-3"><input type="text" name="txtdes[5]" size="30">	<a href="#" onclick="remove(5)">Delete</a></div>
			</div>
			...
			<div class="col-sm-3 " ></div>
			<div class="col-sm-2 " >
			<select name="cb_brg[6]" id="cb_brg6" class="chosen-select pilihsf" >
			...
			<div class="col-sm-3"><input type="text" name="txtdes[6]" size="30">	<a href="#" onclick="remove(6)">Delete</a></div>
			</div>
			...
			<div class="col-sm-3 " ></div>
			<div class="col-sm-2 " >
			<select name="cb_brg[7]" id="cb_brg7" class="chosen-select pilihsf" >
			...
			<div class="col-sm-3"><input type="text" name="txtdes[7]" size="30">	<a href="#" onclick="remove(7)">Delete</a></div>
			</div>
			...
			<div class="col-sm-3 " ></div>
			<div class="col-sm-2 " >
			<select name="cb_brg[8]" id="cb_brg8" class="chosen-select pilihsf" >
			...
			<div class="col-sm-3"><input type="text" name="txtdes[8]" size="30">	<a href="#" onclick="remove(8)">Delete</a></div>
			</div>
			...
			<div class="col-sm-3 " ></div>
			<div class="col-sm-2 " >
			<select name="cb_brg[9]" id="cb_brg1" class="chosen-select pilihsf" >
			...
			<div class="col-sm-3"><input type="text" name="txtdes[9]" size="30">	<a href="#" onclick="remove(9)">Delete</a></div>
			</div>
			...
			<div class="col-sm-3 " ></div>
			<div class="col-sm-2 " >
			<select name="cb_brg[10]" id="cb_brg10" class="chosen-select pilihsf" >
			...
			<div class="col-sm-3"><input type="text" name="txtdes[10]" size="30">	<a href="#" onclick="remove(10)">Delete</a></div>
			</div>
