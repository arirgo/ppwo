...
$sql	=	mysqli_query($koneksi,"select * from tbl_wo where status_wo like 'reject%' and section='".$akses['section']."' and tgl_permohonan like '".$tgl1."%'");
$no = 1;
...
require_once('config.php');
$sql	=	mysqli_query($koneksi,"select * from tbl_wo where status_wo = '".$status."' and section='".$akses['section']."' and tgl_permohonan like '".$tgl1."%'");
$no = 1;
while($data = mysqli_fetch_array($sql)){
