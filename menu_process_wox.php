...
<thead>
 ...
 <tr>
							...
							require_once("config.php");
								$result="SELECT * FROM tbl_wo where status_wo IN ('approved by IT','on process') order by tgl_permohonan ASC";
								   ...
								   // mengulangi data agar tidak hanya 1 yang tampil
									...
									<?php
										...
										if($data['status_wo']=='waiting'){
												...
												?>
												<td><a href="#" class="edit-finish" data-id="<?php echo $data['no_wo']; ?>" ><button type="submit" class="btn btn-danger btn-xs">FINISH</button></a></td>
												<?php
											}
										echo '</tr>';
