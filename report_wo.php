...
<div class="main-content">
	<div class="main-content-inner">
		...
		<?php if (isset($_POST['tombol'])){
				...
				?>
		<form action="report_wo.php" method="post">
		<table width="80%" id="tblhis" border="0" class="table table-striped table-bordered table-hover">
			<tr>
				<td colspan="9" style=" background-color:#0097FF;">Tabel Report Work Order</td>
			</tr>
			...
			<tr>
				...
				<select name="urut" id="urut">
					<option value="no_wo" selected>Nomor WO</option>
					<option value="section">Section</option>
					<option value="tgl_permohonan">Tgl Permohonan</option>
					<option value="tgl_s_kerja">Tgl Selesai</option>
					<option value="diterima">Dikerjakan</option>
					<option value="status_wo">Status</option>
				...
				<td style="width: 25%; border:0;">
					<button type="submit" class="btn btn-primary btn-xs" style="width: 120px;" name="tombol"  value="SEARCH" id="tombol"><i class="ace-icon fa fa-search"></i> SUBMIT</button>
				</td>
			</tr>
		...
		<?php
			...
			$from	=	$_POST['from'];
				...
				$sql	=	mysqli_query($koneksi,"select * from tbl_wo where tgl_permohonan like '".$thn."-".$bln."%' order by ".$urut." ".$from."");
				$no = 1;
		...
		<tr>
				...
				<td style="width: 15%; border:0;">
				<select name="urut" id="urut">
					<option value="no_pp" selected>Nomor WO</option>
					<option value="section">Section</option>
					<option value="tgl_permohonan">Tgl Permohonan</option>
					<option value="tgl_s_kerja">Tgl Selesai</option>
					<option value="diterima">Dikerjakan</option>
		...
		<?php
			...
			$from	=	$_POST['from'];
				...
				$sql	=	mysqli_query($koneksi,"select * from tbl_wo where tgl_permohonan like '".date('Y')."-".date('m')."%' order by no_wo ASC");
				$no = 1;
				while($data	=	mysqli_fetch_array($sql)){
					echo '<tr>';
					echo '<td>'.$no.'</td>';
