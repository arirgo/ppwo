...
<thead>						
 <tr>
							...
							require_once("config.php");
								$result="SELECT tbl_pp.diterima,it, modul_pp.* FROM tbl_pp inner join modul_pp on tbl_pp.no_pp=modul_pp.no_pp where modul_pp.status not in('','finish') and tbl_pp.pls='$pls'and  modul_pp.dikerjakan='$name'  ORDER BY objectid DESC";
...
<thead>						
 <tr>
								<th data-sortable="true">No.</th>
									...
									<th  data-sortable="true">IT</th>
                                    <th  data-sortable="true">IT TAKE</th>
                                    <th  data-sortable="true">Dikerjakan</th>
									<th  data-sortable="true">Jenis</th>
									<th  data-sortable="true">Action</th>
						    </tr>
							...
							<?php
							require_once("config.php");
								$result1="SELECT tbl_wo.diterima,it, detail_project.* FROM tbl_wo inner join detail_project on tbl_wo.no_wo=detail_project.no_project where detail_project.status not in('','finish') tbl_wo.pls='$pls' and detail_project.username ='$name' ORDER BY objectid DESC";
