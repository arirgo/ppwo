...
<?php
	require_once('config.php');
	$sqlm	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='complete' and tgl_lapor like '".$thn."-".$bln."%' and section = '".$akses['section']."'");
	$data1	=	mysqli_fetch_array($sqlm);
	$sqln	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='finish' and tgl_lapor like '".$thn."-".$bln."%' and section = '".$akses['section']."'");
	$data2	=	mysqli_fetch_array($sqln);
	$sqlo	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='hold' and tgl_lapor like '".$thn."-".$bln."%' and section = '".$akses['section']."'");
	$data3	=	mysqli_fetch_array($sqlo);
	$sqlp	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='on process' and tgl_lapor like '".$thn."-".$bln."%' and section = '".$akses['section']."'");
...
<?php
	require_once('config.php');
	$sqlr	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='finish' and tgl_permohonan like '".$thn."-".$bln."%' and section = '".$akses['section']."'");
	$data6	=	mysqli_fetch_array($sqlr);
	$sqls	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='on process' and tgl_permohonan like '".$thn."-".$bln."%' and section = '".$akses['section']."'");
	$data7	=	mysqli_fetch_array($sqls);
	$sqlt	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='hold' and tgl_permohonan like '".$thn."-".$bln."%' and section = '".$akses['section']."'");
	$data8	=	mysqli_fetch_array($sqlt);
	$sqlu	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='approved by IT' and tgl_permohonan like '".$thn."-".$bln."%' and section = '".$akses['section']."'");
	...
	$sqlw	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo like 'reject%'  and tgl_permohonan like '".$thn."-".$bln."%' and section = '".$akses['section']."'");
	...
	?>
		...
		<tr>
				<td class="edit-record9">Approved by IT</td>
...
<?php
	require_once('config.php');
	$sqlm	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='complete' and tgl_lapor like '".$thn1."-".$bln1."%' and section = '".$akses['section']."'");
	$data1	=	mysqli_fetch_array($sqlm);
	$sqln	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='finish' and tgl_lapor like '".$thn1."-".$bln1."%' and section = '".$akses['section']."'");
	$data2	=	mysqli_fetch_array($sqln);
	$sqlo	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='hold' and tgl_lapor like '".$thn1."-".$bln1."%' and section = '".$akses['section']."'");
	$data3	=	mysqli_fetch_array($sqlo);
	$sqlp	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='on process' and tgl_lapor like '".$thn1."-".$bln1."%' and section = '".$akses['section']."'");
	$data4	=	mysqli_fetch_array($sqlp);
...
<?php
	require_once('config.php');
	$sqlr	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='finish' and tgl_permohonan like '".$thn1."-".$bln1."%' and section = '".$akses['section']."'");
	$data6	=	mysqli_fetch_array($sqlr);
	$sqls	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='on process' and tgl_permohonan like '".$thn1."-".$bln1."%' and section = '".$akses['section']."'");
	$data7	=	mysqli_fetch_array($sqls);
	$sqlt	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='hold' and tgl_permohonan like '".$thn1."-".$bln1."%' and section = '".$akses['section']."'");
	$data8	=	mysqli_fetch_array($sqlt);
	$sqlu	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='approved by IT' and tgl_permohonan like '".$thn1."-".$bln1."%' and section = '".$akses['section']."'");
	$data9	=	mysqli_fetch_array($sqlu);
	...
	$data10	=	mysqli_fetch_array($sqlv);
	$sqlw	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo like 'reject%'  and tgl_permohonan like '".$thn1."-".$bln1."%' and section = '".$akses['section']."'");
	$data11	=	mysqli_fetch_array($sqlw);
