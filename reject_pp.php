...
<div class="panel panel-default">
	...
	<div class="col-xs-12">
	<!-- PAGE CONTENT BEGINS -->
	<form name="f_rj" action="reject_pp_proses.php" method="POST" class="form-horizontal" role="form" onsubmit='return kosong();'>
		...
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Permasalahan Komputer</label>
				<div class="col-sm-9">
					<textarea rows="3" cols="35 " id="txturaian" class="col" name="txturaian" readonly><?php echo $data['kerusakan'];?></textarea>
		...
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Alasan</label>
				<div class="col-sm-9">
					<textarea rows="3" cols="35 " id="txtalasan" class="col" placeholder="Reason Reject" name="txtalasan"></textarea>
