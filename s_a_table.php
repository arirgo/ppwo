...
<thead>					
		<tr>
			...
			<th  data-sortable="true">Pelapor</th>
...
//$sql	=	mysqli_query($koneksi,"select * from tbl_pp where status_pp = '".$status."' and tgl_lapor like '".$tgl."%'");
$sql	=	mysqli_query($koneksi,"select * from tbl_pp where status_pp = '".$status."' and pls='$pls' order by tgl_lapor desc");
