...
<!-- /.breadcrumb --></div>
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					Selamat Datang di Permintaan Perbaikan &amp; Work Order IT Online
				</h1>
			</div><!-- /.page-header -->
			<!-- -->
							...
							<table width="60%" class="table table-striped table-bordered table-hover">
								...
								<tr>
									...
									<td align="right">
										...
										$sql	=	mysqli_query($koneksi,"select sum(downtime) as dt from tbl_pp where status_pp in ('finish','complete') and tgl_lapor like '".$thn."-".$bln."%' and tgl_s_kerja like '".$thn."-".$bln."%'");
...
<?php
	require_once('config.php');
	$sqlm	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='complete'");
	$data1	=	mysqli_fetch_array($sqlm);
	$sqln	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='finish'");
	$data2	=	mysqli_fetch_array($sqln);
	$sqlo	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='hold'");
	$data3	=	mysqli_fetch_array($sqlo);
	$sqlp	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='on process'");
	$data4	=	mysqli_fetch_array($sqlp);
	$sqlq	=	mysqli_query($koneksi,"select status_pp, count(status_pp) as jml from tbl_pp where status_pp='waiting'");
...
<?php
	require_once('config.php');
	$sqlr	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='finish'");
	$data6	=	mysqli_fetch_array($sqlr);
	$sqls	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='on process'");
	$data7	=	mysqli_fetch_array($sqls);
	$sqlt	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='hold'");
	$data8	=	mysqli_fetch_array($sqlt);
	$sqlu	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='approved by SH'");
	$data9	=	mysqli_fetch_array($sqlu);
	$sqlv	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo='waiting'");
	$data10	=	mysqli_fetch_array($sqlv);
	$sqlw	=	mysqli_query($koneksi,"select status_wo, count(status_wo) as jml from tbl_wo where status_wo like 'reject%'");
	...
	<script src="js1/bootstrap-table.js"></script>
        ...
        $(function(){
            ...
            $(document).on('click','.edit-record6',function(e){
				window.open('s_a_table_wo.php?n=finish',
							'winpopup',
							'toolbar=no,statusbar=no,menubar=no,resizable=yes,scrollbars=yes,width=1200,height=500'
							);
            });
             ...
             $(document).on('click','.edit-record7',function(e){
				window.open('s_a_table_wo.php?n=on process',
							'winpopup',
							'toolbar=no,statusbar=no,menubar=no,resizable=yes,scrollbars=yes,width=1200,height=500'
							);
            });
             ...
             $(document).on('click','.edit-record8',function(e){
				window.open('s_a_table_wo.php?n=hold',
							'winpopup',
							'toolbar=no,statusbar=no,menubar=no,resizable=yes,scrollbars=yes,width=1200,height=500'
							);
            });
             ...
             $(document).on('click','.edit-record9',function(e){
				window.open('s_a_table_wo.php?n=approved by SH',
							'winpopup',
							'toolbar=no,statusbar=no,menubar=no,resizable=yes,scrollbars=yes,width=1200,height=500'
							);
            });
             ...
             $(document).on('click','.edit-record10',function(e){
				window.open('s_a_table_wo.php?n=waiting',
							'winpopup',
							'toolbar=no,statusbar=no,menubar=no,resizable=yes,scrollbars=yes,width=1200,height=500'
							);
            });
            ...
            $(document).on('click','.edit-record11',function(e){
				window.open('s_a_table_wo.php?n=reject',
							'winpopup',
							'toolbar=no,statusbar=no,menubar=no,resizable=yes,scrollbars=yes,width=1200,height=500'
							);
            });
