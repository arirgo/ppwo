...
<div class="row">
	<div class="col-sm-6">
		<?php
			$syn = mysqli_query($koneksi,"select count(no_pp) as nopp from tbl_pp where status_pp = 'hold'");
	...
	<div class="col-sm-6">
		<?php
			$syn = mysqli_query($koneksi,"select count(no_wo) as nowo from tbl_wo where status_wo = 'hold'");
			$datsyn = mysqli_fetch_array($syn);
