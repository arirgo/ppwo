								   ...
								   // mengulangi data agar tidak hanya 1 yang tampil
									...
									<?php
										...
										if($data['status_pp']=='waiting'){
												...
												echo '<td><form name="f_take" action="hold_pp.php" method="POST"><input type="hidden" name="txthold" value="'.$data['no_pp'].'"><button type="submit" class="btn btn-inverse btn-xs">HOLD</button></form></td>';
											}
										echo '</tr>';
